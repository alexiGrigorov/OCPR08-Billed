...
export default class Login {
  ...
  handleSubmitAdmin = (e) => {
    // BUG #1: typo for selecting the wrong input
    // original: `input[data-testid="employee-email-input"]` && `input[data-testid="employee-password-input"]`
    // fixed: `input[data-testid="admin-email-input"]` && `input[data-testid="admin-password-input"]`
    e.preventDefault();
    const user = {
      type: "Admin",
